...
public class CharacterStatsHandler : MonoBehaviour
{
    ...
    public void AddStatModifer(CharacterStats statModifier)
    {
        statsModifers.Add(statModifier);
        UpdateCharacterStats();
    }

    public void RemoveStatModifer(CharacterStats statModifier)
    {
        statsModifers.Remove(statModifier);
        UpdateCharacterStats();
    }
    ...
    private void UpdateCharacterStats()
    {
        ...
        foreach (CharacterStats modifier in statsModifers.OrderBy(o => o.statsChangeType))
        {
